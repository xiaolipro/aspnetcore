...
internal abstract class RoutePatternClassifierBase : IAspNetCoreEmbeddedLanguageClassifier
{
    public void RegisterClassifications(AspNetCoreEmbeddedLanguageClassificationContext context)
    {
        ...
        var tree = RoutePatternParser.TryParse(virtualChars, GetOptions(usageContext));
    ...
    protected abstract RoutePatternOptions GetOptions(RoutePatternUsageContext context);
